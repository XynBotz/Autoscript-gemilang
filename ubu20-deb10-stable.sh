...
# // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "DEVELOPER : ${green}GEMILANG - KINASIH® ${NC}${YELLOW}(${NC} ${green} PREMIUM ${NC}${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# // REPO    
REPO="https://raw.githubusercontent.com/gemilangkinasih/Autoscript/GM/"
...
echo -e "   ════════════════════════════════════"
read -p "   Please select numbers 1 Atau 2 >>>" host
echo ""
if [[ $host == "1" ]]; then
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/gemilangkinasih/Autoscript/GM/Registrasi"
...
TIMES="10"
CHATID="6878488884"
KEY="6878488884:AAH5VLFGj3br3NBS0MitIqZk3HhDoJZWia0"
...
<code>═══════════════════════</code>
<b>🇮🇩🇮🇩GEMILANG KINASIH🇮🇩🇮🇩</b>
<code>═══════════════════════</code>
<i>Automatic Notifications From Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/+6287786741106"}]]}' 
...
wget -q https://raw.githubusercontent.com/gemilangkinasih/Autoscript/GM/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
